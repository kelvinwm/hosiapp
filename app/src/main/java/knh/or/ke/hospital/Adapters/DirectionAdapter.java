...
public class DirectionAdapter extends RecyclerView.Adapter<DirectionAdapter.ClinicViewHolder> implements Filterable {


    //this context we will use to inflate the layout
    private Context mCtx;
    private DirectionAdapterListener listener;
    private List<ClinicList> clinicList;
    private List<ClinicList> searchList;

    //getting the context and clinic list with constructor
    public DirectionAdapter(Context mCtx, List<ClinicList> clinicList){
        this.mCtx = mCtx;
    ...
    @Override
    public DirectionAdapter.ClinicViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        //inflating and returning our view holder
        LayoutInflater inflater = LayoutInflater.from(mCtx);
        View view = inflater.inflate(R.layout.directionitem, null);

        return new DirectionAdapter.ClinicViewHolder(view);
    }

    @Override
    public void onBindViewHolder(DirectionAdapter.ClinicViewHolder holder, int position) {
    ...
    public interface DirectionAdapterListener {
